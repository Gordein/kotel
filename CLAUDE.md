...
- Делёж: поровну между выбранными ИЛИ «разные доли» (сумма на каждого, итог = их сумма;
  `split_mode=custom`, поля `cpid`/`camount`). Плательщик всегда — текущий пользователь.
